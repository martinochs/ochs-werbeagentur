      ...
      <div className="mx-auto max-w-6xl px-4 lg:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
          ...
          <div className="flex flex-col rounded-[2rem] border border-red-100 bg-[#fff5f5] p-6 lg:p-8">
            ...
            <div className="mt-auto flex min-h-[140px] items-center gap-4 rounded-2xl bg-[#ef4444] p-5 text-white shadow-md md:min-h-[120px]">
          ...
          <div className="flex flex-col rounded-[2rem] border border-green-100 bg-[#f0fdf4] p-6 lg:p-8">
            ...
            <div className="mt-auto flex min-h-[140px] items-center gap-4 rounded-2xl bg-[#16a34a] p-5 text-white shadow-md md:min-h-[120px]">
